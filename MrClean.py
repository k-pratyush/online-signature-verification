...
#df.set_axis(['FNo','X','Y','Pressure','Azm','PenEl','UserNo',
#             'SampNo','Output','X_Len','Y_Len','Avg_Ps','Ratio','Diff_Pen',
#             'Diff_Azm','Pen_Up','Sign_time','X_Speed','Y_Speed'],axis=1, inplace=True)
